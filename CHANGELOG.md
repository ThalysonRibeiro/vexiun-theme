...
- Finalized semantic highlighting system optimized for React, TypeScript, and Next.js.
- Added Vexiun Bloom theme.

### Changed

- Refined semantic token differentiation (functions, methods, async, declarations).
- Simplified and standardized JSON highlighting.
- Improved Markdown styling consistency.
- Polished UI focus states, borders, and panel visuals.
- Cleaned up token colors across all themes.

### Removed

- Removed Vexiun Mono Dark, Vexiun Mono Light, Vexiun Zinc, Vexiun Purple, and Vexiun Strawberry themes to streamline the collection.
...
- Added a debug step to the release workflow to investigate an issue with the .vsix file not being found.
